		...
		<view class="box">
			<view class="cu-bar tabbar bg-white shadow foot">
				...
				<view class="action" @click="NavChange" data-cur="search">
					...
					<view :class="PageCur=='search'?'color_main':'text-gray'">在线识别</view>
				</view>
				...
				<view @click="NavChange" class="action text-gray add-action" data-cur="cases">
					...
					<view :class="PageCur=='cases'?'color_main':'text-gray'">项目介绍</view>
				</view>
				...
				<view class="action" @click="NavChange" data-cur="news">
					...
					<view :class="PageCur=='news'?'color_main':'text-gray'">在线论坛</view>
				</view>
